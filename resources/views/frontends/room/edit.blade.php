        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="form-material form-horizontal" action="{{ route('rooms.update', $room->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="status" class="form-control @error('status') is-invalid @enderror">
                                            ...
                                            <option value="maintenance" {{ $room->status == 'maintenance' ? 'selected' : '' }}>@lang('Under Maintenance')</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
                                                {{ $message }}
