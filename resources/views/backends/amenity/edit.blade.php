<div class="modal fade" id="edit_amenity-{{ $amenity->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ $amenity->name }}"
                                class="form-control @error('name') is-invalid @enderror" placeholder="@lang('Enter amenity name')"
                                required>
                        </div>
                        <div class="col-sm-6">
