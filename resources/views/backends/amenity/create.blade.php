      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">@lang('Create Amenity')</h5>
                  ...
                  <form action="{{ route('amenities.store') }}" method="POST">
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-12">
                              ...
                              <textarea name="description" rows="5" id="description" class="form-control" placeholder="@lang('Enter amenity description')"></textarea>
                          </div>
                          <div class="mt-2">
                              <button type="submit"
