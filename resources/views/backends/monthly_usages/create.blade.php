...
<div class="card">
    <div class="card-header">
        <label class="card-title text-uppercase">@lang('Add Monthly Usage')</label>
    </div>
    <form action="{{ route('monthly_usages.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" name="usage" id="usage" class="form-control @error('usage') is-invalid @enderror" step="0.01" placeholder="@lang('Enter Usage')">
                @error('usage')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
