            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <label class="card-title text-uppercase">@lang('Edit Room')</label>
                    </div>
                    <form action="{{ route('rooms.update', ['room' => $room->id]) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="room_number" id="room_number" class="form-control @error('room_number') is-invalid @enderror" value="{{ $room->room_number }}">
                                @error('room_number')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="floor" id="floor" class="form-control" value="{{ $room->floor }}">
                            </div>

                            <div class="form-group">
                                <label for="status">@lang('Status')</label>
                                <input type="text" name="status" id="status" class="form-control" value="{{ $room->status }}">
                            </div>
                        </div>
